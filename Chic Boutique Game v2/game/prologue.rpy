...
#Bottoms
    ...
    imagebutton auto "Dana_Imgs/Dana_Bottom_2_%s.png" align(0.64, 0.56) action [Show("bottom1"), Hide("bottom0"), Hide("bottom2"), SetVariable("bottom", 1)]
...
#Shoes
    ...
    imagebutton auto "Dana_Imgs/Dana_Shoe_3_%s.png" align(0.78, 0.88) action [Show("shoe3"), Hide("shoe1"), Hide("shoe2"),SetVariable("shoe", 2)]
